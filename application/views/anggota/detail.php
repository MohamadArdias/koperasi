    ...
    <div class="card-body mt-4">
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    <i class="bi-person-fill input-group-text"></i>
                    <input type="text" name="REKENING" class="form-control" id="REKENING" value="<?= $anggota['REKENING']; ?>" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    <i class="bi-briefcase-fill input-group-text"></i>
                    <input type="text" name="KODE_INS" class="form-control" id="KODE_INS" value="<?= $anggota['KODE_INS'].'/'.$anggota['NAMA_INS']; ?>" readonly >
                </div>
            </div>
        </div>
		...
		<div class="form-group row mb-2">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="TELP_ANG" placeholder="-" name="TELP_ANG" value="<?= $anggota['TELP_ANG']; ?>" readonly>
                </div>
            </div>
        </div>
