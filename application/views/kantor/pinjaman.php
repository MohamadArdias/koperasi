            ...
            <table class="table table-borderless datatable" id="customers">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th style="padding-left: 70px; padding-right: 70px;" max="10" class="text-center">Anggota</th>
                        ...
                        <th class="text-center">Total Bunga</th>
                        <th style="padding-left: 45px; padding-right: 45px;" class="text-center">Status</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                            <td><?= $key['TGLP_ANG'] ?></td>
                            <td><?= $key['NOFAK']; ?></td>
                            <td><a href="<?= base_url(); ?>index.php/kantor/daftar/<?= $key['KODE_ANG'] ?>"><?= $key['KODE_ANG'] . '/' . $key['NAMA_ANG']; ?></a></td>
                            ...
                            <td class="text-right"><?= number_format($key['SIBNGU' . $angka], 0, ',', '.'); ?></td>
                            <td><?= $status; ?></td>
                        </tr>
                    <?php
                    } ?>
