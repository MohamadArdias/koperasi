                        ...
                        <?php foreach ($keuangan as $ins) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url(); ?>index.php/tunggakan/printins/<?= $ins['KODE_INS']; ?>?TAHUN=<?= $ins['TAHUN']; ?>&&BULAN=<?= $ins['BULAN']; ?>" class="btn btn-success" target="blank">Print Instansi</a>
                                    <a href="<?= base_url(); ?>index.php/tunggakan/printinsang/<?= $ins['KODE_INS']; ?>?TAHUN=<?= $ins['TAHUN']; ?>&&BULAN=<?= $ins['BULAN']; ?>" class="btn btn-primary" target="blank">Print Aggota</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
